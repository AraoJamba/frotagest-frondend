    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Gerencie todos os motoristas da frota</p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-muted border-b border-border">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-semibold text-foreground">Nº da Carta</th>
              ...
              <tbody className="divide-y divide-border">
                {motoristasFiltrados.map((motorista) => (
                  <tr key={motorista.id} className="hover:bg-muted/50 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground font-medium">{motorista.nome}</td>
                    <td className="px-6 py-4 text-sm text-muted-foreground">{motorista.email}</td>
                    <td className="px-6 py-4 text-sm text-muted-foreground">{motorista.numeroCarta}</td>
