      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(v) => handleChange('tipo_manutencao', v)}
            >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              disabled={carregando}
              className={`${inputStyle} ${erros.responsavel && 'border-red-500'}`}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              disabled={carregando}
              className={`${inputStyle} ${erros.custo && 'border-red-500'}`}
              placeholder="Ex: 15000"
            />

            {erros.custo && (
              <p className="text-xs text-red-500">{erros.custo}</p>
            )}
          </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            disabled={carregando}
            className={`min-h-[120px] rounded-xl border-slate-200 bg-slate-50 text-sm ${erros.descricao && 'border-red-500'}`}
            placeholder="Detalhes da manutenção..."
          />

          {erros.descricao && (
            <p className="text-xs text-red-500">{erros.descricao}</p>
          )}
        </div>
